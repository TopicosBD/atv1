...
/**
 * Classe que cont�m atributos para efetuar o login padr�o com qualquer Banco de
 * Dados.
 */
public abstract class BD {

    /**
     * Objeto que permite fazer a conexao com o Banco de Dados.
     */
    Connection conn;
    /**
     * Atributo para identificar o login do objeto BD.
     */
    String login;

    /**
     * Atributo para identificar a senha do objeto BD.
     */
    String senha;
