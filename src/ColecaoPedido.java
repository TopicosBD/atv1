...
public class ColecaoPedido {
    ...
    /**
     * Metodo que monta o menu principal e obtem uma opcao do usuario
     */
    ...
    public void AdicionarItems(Pedido p) throws Exception {
        ...
        do {
            ...
            //pedidoBD.AdicionarItemBD(new Item(descricao, quantidade, valorunitario), p.getId());
            pedidoBD.AdicionarItemBD(new Item(descricao, quantidade, valorunitario), p);
